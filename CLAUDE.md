...
- 내용: `_pages/` (about=홈, people, research=Key Research Outputs, projects, news(메뉴 밖)). 메뉴 순서는 사람 우선: about · people · research · projects, `_data/members.yml`, `_data/projects.yml`, `_bibliography/papers.bib`, `_news/`
